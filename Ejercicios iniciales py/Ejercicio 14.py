...
# la descomposición de dicho importe en el menor número de billetes y monedas de 100, 50, 20, 10, 5, 2 y 1
# euro. En el caso de que alguna moneda no intervenga en la descomposición no se tiene que visualizar nada en
# la pantalla. Para una cantidad de 2236 euros la salida que generaría el programa sería:
